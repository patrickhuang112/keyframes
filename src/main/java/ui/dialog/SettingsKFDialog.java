...
public class SettingsKFDialog extends JDialog implements KFDialog {
	...
	SettingsKFDialog(String title, Settings settings) {
		super(SettingsKFDialog.nullFrame, title, true);
	...
	private void buildUI() {
		...
		JSlider brushSizeSlider = KFSliderFactory.createStandardTenTickSlider( 
		...
		JSlider fpsSlider = KFSliderFactory.createStandardFiveTickSlider( 
				settings.fpsMin, settings.fpsMax, settings.getFps()).getSwingComponent();
		
		JSlider compositionLengthSlider = KFSliderFactory.createStandardFiveTickSlider( 
